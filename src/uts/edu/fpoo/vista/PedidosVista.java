...
import java.awt.*;      // FlowLayout y otros layouts
...
public class PedidosVista extends javax.swing.JFrame {
    ...
    public PedidosVista() {
        initComponents();
        PlatosDAO pd = new PlatosDAO();
        ArrayList<Platos> platos = pd.listar();
        for (Platos p : platos) {
            selectMenu.addItem(p.getNombre());
        }
    ...
    private void initComponents() {
        ...
        selectMenu.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(selectMenu, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void selectMenuActionPerformed(java.awt.event.ActionEvent evt) {                                           
